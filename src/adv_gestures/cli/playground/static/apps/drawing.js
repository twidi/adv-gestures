...
export class DrawingApplication extends BaseApplication {
    ...
    drawIndicators() {
        ...
        // Draw hand icons
        const iconSize = this.INDICATOR_SIZE * 0.42; // Bigger icons
        const spacing = this.INDICATOR_SIZE * 0.05; // Less space between icons
